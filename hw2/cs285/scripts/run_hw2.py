...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        print(f"\n********** Iteration {itr} ************")
        # FIXED: sample `args.batch_size` transitions using utils.sample_trajectories
        ...
        # FIXED: train the agent using the sampled trajectories and the agent's update function

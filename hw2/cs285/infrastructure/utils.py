...
def sample_trajectory(
    ...
    while True:
        ...
        # FIXED use the most recent ob and the policy to decide what to do
        ac = policy.get_action(ob)[0]

        # FIXED: use that action to take a step in the environment
        next_ob, rew, done, _ = env.step(ac)

        # FIXED rollout can end due to done, or due to max_length
        steps += 1
